...
export const LocalDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/local${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="immoxpertsApp.local.delete.question">Êtes-vous certain de vouloir supprimer le Local {localEntity.id} ?</ModalBody>
      <ModalFooter>
