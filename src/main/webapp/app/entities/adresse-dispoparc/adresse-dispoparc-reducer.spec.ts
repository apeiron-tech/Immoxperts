...
import reducer, {
  ...
  reset,
  updateEntity,
} from './adresse-dispoparc.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADRESSEDISPOPARC_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADRESSEDISPOPARC actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADRESSEDISPOPARC actions', async () => {
      const arg = { id: 30972 };
    ...
    it('dispatches UPDATE_ADRESSEDISPOPARC actions', async () => {
      const arg = { id: 30972 };
    ...
    it('dispatches PARTIAL_UPDATE_ADRESSEDISPOPARC actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADRESSEDISPOPARC actions', async () => {
      const arg = 42666;
