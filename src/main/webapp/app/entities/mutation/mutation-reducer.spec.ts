...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './mutation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MUTATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MUTATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MUTATION actions', async () => {
      const arg = { id: 22244 };
    ...
    it('dispatches UPDATE_MUTATION actions', async () => {
      const arg = { id: 22244 };
    ...
    it('dispatches PARTIAL_UPDATE_MUTATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MUTATION actions', async () => {
      const arg = 42666;
