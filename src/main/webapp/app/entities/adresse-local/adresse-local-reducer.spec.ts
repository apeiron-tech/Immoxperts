...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADRESSELOCAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADRESSELOCAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADRESSELOCAL actions', async () => {
      const arg = { id: 6508 };
    ...
    it('dispatches UPDATE_ADRESSELOCAL actions', async () => {
      const arg = { id: 6508 };
    ...
    it('dispatches PARTIAL_UPDATE_ADRESSELOCAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADRESSELOCAL actions', async () => {
      const arg = 42666;
