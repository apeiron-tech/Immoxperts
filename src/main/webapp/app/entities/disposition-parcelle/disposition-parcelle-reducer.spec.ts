...
import reducer, {
  ...
  reset,
  updateEntity,
} from './disposition-parcelle.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPOSITIONPARCELLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISPOSITIONPARCELLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISPOSITIONPARCELLE actions', async () => {
      const arg = { id: 1031 };
    ...
    it('dispatches UPDATE_DISPOSITIONPARCELLE actions', async () => {
      const arg = { id: 1031 };
    ...
    it('dispatches PARTIAL_UPDATE_DISPOSITIONPARCELLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISPOSITIONPARCELLE actions', async () => {
      const arg = 42666;
