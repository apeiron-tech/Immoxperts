...
import { Plus, ChevronDown, Zap, Building2, Link as LinkIcon, FileEdit } from 'lucide-react';
...
const SplitButtonCreationAdV: React.FC<Props> = ({ onDepuisEstimation, onDepuisPortefeuille, onDepuisAnnonce, onSaisieManuelle }) => {
  ...
  return (
    <div className="relative flex" ref={ref}>
      <button
        ...
        title="Depuis une estimation rapide (mode prioritaire)"
      >
        <Plus size={14} />
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 bg-white border border-slate-200 rounded-md shadow-sm py-1 z-20 w-64">
          <DropdownItem
            icon={<Zap size={14} className="text-propsight-500" />}
            label="Depuis une estimation rapide"
...
export default SplitButtonCreationAdV;
