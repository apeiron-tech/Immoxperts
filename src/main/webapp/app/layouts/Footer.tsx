...
const Footer: React.FC = () => {
  const footerLinks = {
    produit: [
      { label: 'Carte des prix', href: '/priximmobilier' },
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            {/* Social Media Icons */}
            <div className="pt-4">
              <h4 className="font-semibold text-white mb-4">Retrouvez-nous sur :</h4>
              <div className="flex items-center gap-3">
                {/* X (Twitter) */}
                <a
                  href="https://x.com/propsight_fr?s=21"
                  target="_blank"
                ...
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/propsight_fr?igsh=aHYzaGQ1djhob25u&utm_source=qr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                ...
                {/* LinkedIn */}
                <a
                  href="https://www.linkedin.com/company/propsight-fr/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                  aria-label="LinkedIn"
                ...
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/share/1AYoWTJ2dg/?mibextid=wwXIfr"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                  aria-label="Facebook"
                ...
                {/* TikTok */}
                <a
                  href="https://www.tiktok.com/@propsight?_r=1&_t=ZN-92hz2ycEAZ4"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                  aria-label="TikTok"
                ...
                {/* YouTube */}
                <a
                  href="https://youtube.com/@propsight-fr?si=F9NdDV6Sxx_n7dFm"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                  aria-label="YouTube"
