...
tarteaucitron.services.piwikpro = {
  ...
  js: function () {
    ...
    var isStgDebug =
      (window.location.href.match('stg_debug') || document.cookie.match('stg_debug')) && !window.location.href.match('stg_disable_debug');
    stgCreateCookie('stg_debug', isStgDebug ? 1 : '', isStgDebug ? 14 : -1);
    var qP = [];

    var qPString = qP.length > 0 ? '?' + qP.join('&') : '';
    tarteaucitron.addScript(
      'https://' + tarteaucitron.user.piwikProContainer + '.containers.piwik.pro/' + tarteaucitron.user.piwikProId + '.js' + qPString,
    );
...
tarteaucitron.services.plezi = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      'https://brain.plezi.co/api/v1/analytics?tenant=' + tarteaucitron.user.pleziTenant + '&tw=' + tarteaucitron.user.pleziTw,
    );
  },
};
...
tarteaucitron.services.instagram = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(['instagram_post'], function (x) {
      ...
      post_frame =
        '<iframe title="' + frame_title + '" src="//www.instagram.com/' + post_link + '/embed" style="' + styleAttr + '"></iframe>';
...
tarteaucitron.services.issuu = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(['issuu_player'], function (x) {
      ...
      issuu_frame =
        '<iframe title="' + frame_title + '" style="' + styleAttr + '" src="//e.issuu.com/embed.html' + issuu_embed + '"></iframe>';
...
tarteaucitron.services.acast = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(['acast_embed'], function (x) {
      ...
      return (
        '<iframe title="' + frame_title + '" src="' + widgetURL + '" style="border: none; overflow: hidden;' + styleAttr + '"></iframe>'
      );
    });
  },
  fallback: function () {
...
tarteaucitron.services.webtvnu = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(['webtvnu_player'], function (x) {
      ...
      return (
        '<iframe title="' + frame_title + '" style="' + styleAttr + '" src="' + frame_url + '" allowfullscreen allow="autoplay"></iframe>'
      );
    });
  },
  fallback: function () {
