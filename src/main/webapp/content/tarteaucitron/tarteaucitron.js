...
var tarteaucitronScriptsDiscover = document.getElementsByTagName('script'),
  ...
  tarteaucitronExpireInDay =
    tarteaucitronExpireInDay === undefined || typeof tarteaucitronExpireInDay !== 'boolean' ? true : tarteaucitronExpireInDay,
...
var tarteaucitron = {
  ...
  load: function () {
    ...
    var cdn = tarteaucitron.cdn,
      ...
      useMinifiedJS =
        new URL(cdn, tarteaucitronPath).host == 'cdn.jsdelivr.net' || tarteaucitronPath.indexOf('.min.') >= 0 || tarteaucitronUseMin !== '',
    ...
    tarteaucitron.addInternalScript(pathToLang, '', function () {
      ...
      tarteaucitron.addInternalScript(pathToServices, '', function () {
        ...
        html +=
          '         <span class="tarteaucitronH1" role="heading" aria-level="2" id="dialogTitle">' + tarteaucitron.lang.title + '</span>';
        ...
        if (tarteaucitron.parameters.adblocker === true) {
          setTimeout(function () {
            if (tarteaucitronNoAdBlocker === false) {
              ...
              html += '</div>';
              html +=
                '<div role="heading" aria-level="2" id="tac_title" class="tac_visually-hidden">' + tarteaucitron.lang.title + '</div>';
              html += '<div id="tarteaucitronPremium"></div>';
          ...
          setTimeout(function () {
            ...
            if (closeElement) {
              closeButton.innerHTML =
                '<span aria-hidden="true">X</span><span class="tac_visually-hidden">' + tarteaucitron.lang.closeBanner + '</span>';
  ...
  addService: function (serviceId) {
    ...
    if ((!isResponded && (isAutostart || (isNavigating && isWaiting)) && !tarteaucitron.highPrivacy) || isAllowed) {
      ...
      if (tarteaucitron.launch[service.key] !== true) {
        ...
        if (
          (typeof tarteaucitronMagic === 'undefined' || tarteaucitronMagic.indexOf('_' + service.key + '_') < 0) &&
  ...
  userInterface: {
        ...
        if (tarteaucitron.state[key] !== status) {
          ...
          if (status === false && tarteaucitron.launch[key] === true) {
            ...
            if (tarteaucitron.checkIfExist('tarteaucitronClosePanel')) {
              var ariaCloseValue =
                document.getElementById('tarteaucitronClosePanel').textContent.trim() + ' (' + tarteaucitron.lang.reload + ')';
          ...
          if (tarteaucitron.launch[key] !== true && status === true) {
            ...
            if (
              (typeof tarteaucitronMagic === 'undefined' || tarteaucitronMagic.indexOf('_' + key + '_') < 0) &&
              tarteaucitron.parameters.serverSide !== true
            ) {
    ...
    closePanel: function () {
      ...
      if (
        !(tarteaucitron.parameters.orientation === 'middle' && document.getElementById('tarteaucitronAlertBig').style.display === 'block')
      ) {
        if (document.getElementsByTagName('html')[0].classList !== undefined) {
  ...
  getElemAttr: function (elem, attr) {
    var attribute =
      elem.getAttribute('data-' + attr) || elem.getAttribute(attr) || elem.getAttribute(attr.startsWith('data-') ? attr.slice(5) : attr);
